    ...
    async (userId, { rejectWithValue }) => {
        try {
            const response = await axios.get(
                `${REACT_APP_API}zenstudy/api/user/userdetail/${userId}`,
                {
                    headers: {
            ...
            return {
                ...data.userdetail,
                imageUrl: `${REACT_APP_API}zenstudy/api/image/getimage/${data.userdetail.avatar}`,
            };
    ...
    async ({ userId, userUpdate }, { rejectWithValue }) => {
        try {
            const response = await axios.put(
                `${REACT_APP_API}zenstudy/api/user/updateUserN/${userId}`,
                userUpdate,
                {
                    headers: {
                        Accept: 'application/json',
